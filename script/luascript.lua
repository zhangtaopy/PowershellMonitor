...
function powershellcheck(jsonstring)
	...
	local logpath = "e:\\code\\PowershellMonitor1\\Release\\log.dat"
	local binarypath = "e:\\code\\PowershellMonitor1\\Release\\binary.dat"
	local scriptpath = "e:\\code\\PowershellMonitor1\\Release\\script.dat"
